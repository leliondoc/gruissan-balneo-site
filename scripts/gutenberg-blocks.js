...
const styleClassMap = new Map([
  ['text-align:left;margin-bottom:var(--space-md)', ['balneo-aligner-gauche', 'balneo-espace-bas-moyen']],
  ['margin-top:var(--space-md)', ['balneo-espace-haut-moyen']],
  ['text-align:center', ['balneo-aligner-centre']],
  ['margin:var(--space-lg)0', ['balneo-espace-vertical-grand']],
]);

const groupLabelMap = [
  ['hero-page__media', 'Image de couverture'],
  ['hero-page__contenu', 'Contenu de la bannière'],
  ['hero-page', 'Bannière de page'],
  ['hero-accueil__media', 'Image d’accueil'],
  ['hero-accueil__contenu', 'Introduction de l’accueil'],
  ['hero-accueil__sceaux', 'Pastilles d’information'],
  ['acces-rapides', 'Accès rapides'],
  ['bloc-contenu', 'Contenu de la page'],
  ['encadre-info', 'Encart d’information'],
  ['grille-liens', 'Grille de liens'],
  ['carte-lien', 'Carte liée'],
  ['grille-experiences', 'Grille des expériences'],
  ['carte-experience', 'Carte expérience'],
  ['section-saisons', 'Sélection saisonnière'],
  ['diapositive-saison', 'Carte saisonnière'],
  ['grille-actualites', 'Grille des actualités'],
  ['carte-actualite', 'Carte actualité'],
  ['grille-contact', 'Bloc contact'],
  ['deux-colonnes', 'Deux colonnes'],
  ['liste-faq', 'Questions fréquentes'],
  ['entete-section', 'En-tête de section'],
  ['section-contenu__entete', 'En-tête de section'],
