...
if ( in_array( '--fixtures', $argv, true ) ) {
	...
	$_GET = array( 'edit' => 'new' ); ob_start(); balneo_v2_schedule_admin_page(); $new_form = ob_get_clean();
	...
	echo json_encode( array( 'list' => $list, 'form' => $form, 'newForm' => $new_form, 'public' => $public ) );
	exit;
}
