...
<section class="page-hero">
    <div class="page-hero__media media-fill">
      <img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/balneo-188.webp' ) ); ?>" alt="" loading="eager" fetchpriority="high">
    </div>
  ...
  <div class="container content-block fade-in">
    ...
    <div class="two-col" style="margin-top:var(--space-md)">
      ...
      <div class="two-col__media media-fill">
        <img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/balneo-37.webp' ) ); ?>" alt="Espace aquatique">
      </div>
    </div>
    <h3>Les saunas</h3>
