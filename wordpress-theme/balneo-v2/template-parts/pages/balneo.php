<?php
/**
 * Contenu importé de la maquette validée : balneo.html.
 *
 * @package BalneoV2
 */
...
<section class="section section--light">
	...
	<div class="two-col" style="margin-top:var(--space-md)">
		...
		<img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/balneo-37.webp' ) ); ?>" alt="Espace aquatique" width="2560" height="1705" decoding="async" loading="lazy" srcset="<?php echo esc_attr( balneo_v2_theme_image_srcset( 'balneo-37.webp' ) ); ?>" sizes="(max-width: 760px) 100vw, 50vw">
		</div>
	</div>
	<h3>Les saunas</h3>
