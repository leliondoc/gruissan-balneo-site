<?php
/**
 * Contenu importé de la maquette validée : salle-de-sport.html.
 *
 * @package BalneoV2
 */
...
<section class="page-hero">
	<div class="page-hero__media media-fill">
		<img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/balneo-37.webp' ) ); ?>" alt="" loading="eager" fetchpriority="high">
	</div>
