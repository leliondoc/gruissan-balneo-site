<?php
/**
 * Contenu importé de la maquette validée : parc-ete.html.
 *
 * @package BalneoV2
 */
...
<section class="hero-page">
    <div class="hero-page__media media-plein">
      <img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/parc-aquatique.webp' ) ); ?>" alt="" width="1900" height="1259" loading="eager" fetchpriority="high" decoding="async" srcset="<?php echo esc_attr( balneo_v2_theme_image_srcset( 'parc-aquatique.webp' ) ); ?>" sizes="100vw">
    </div>
    <div class="hero-page__voile"></div>
    <div class="hero-page__contenu">
      <p class="hero-page__libelle">Parc aqualudique</p>
      <h1 class="hero-page__titre">Parc été</h1>
