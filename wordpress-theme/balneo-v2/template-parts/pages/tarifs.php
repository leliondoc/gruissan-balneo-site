...
<section class="section section--light"><div class="container content-block fade-in">
  ...
  <h2>Autres univers</h2><div class="link-grid"><a class="link-card" href="<?php echo esc_url( home_url( '/salle-de-sport/' ) ); ?>"><i class="fa-solid fa-dumbbell" aria-hidden="true"></i><h2>Espace For.Me</h2><p>Séances et abonnements.</p><span>Voir les tarifs →</span></a><a class="link-card" href="<?php echo esc_url( home_url( '/massages/' ) ); ?>"><i class="fa-solid fa-spa" aria-hidden="true"></i><h2>Massages</h2><p>Prestations avec ou sans Balnéo.</p><span>Voir la carte →</span></a><a class="link-card" href="<?php echo esc_url( home_url( '/parc-ete/' ) ); ?>"><i class="fa-solid fa-water-ladder" aria-hidden="true"></i><h2>Parc été</h2><p>Pass journée et tarifs enfants.</p><span>Voir les tarifs →</span></a></div>
