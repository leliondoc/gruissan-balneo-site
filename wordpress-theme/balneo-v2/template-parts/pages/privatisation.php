<?php
/**
 * Contenu importé de la maquette validée : privatisation.html.
 *
 * @package BalneoV2
 */
...
<section class="page-hero">
    <div class="page-hero__media media-fill">
      <img src="<?php echo esc_url( get_theme_file_uri( '/assets/photos/bassins-exterieurs.webp' ) ); ?>" alt="" loading="eager" fetchpriority="high">
    </div>
...
<section class="section section--light"><div class="container content-block fade-in">
  ...
  <p><a class="btn btn--filled" href="<?php echo esc_url( home_url( '/contact/' ) ); ?>">Demander une privatisation<i class="fa-solid fa-users" aria-hidden="true"></i></a></p>
</div></section>
</main>
