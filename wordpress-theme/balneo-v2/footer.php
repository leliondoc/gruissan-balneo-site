...
?>
<a class="orbe-appel" href="https://gruissan-balneo.horanet.com/" target="_blank" rel="noopener"><span class="orbe-appel__libelle"><span><?php esc_html_e( 'Acheter', 'balneo-v2' ); ?></span><small><?php esc_html_e( 'en ligne', 'balneo-v2' ); ?></small></span></a>
  <footer class="pied-page-site">
    <div class="conteneur">
      <div class="pied-page__grille">
        <div class="pied-page__logo">
          <?php balneo_v2_site_logo( 'footer' ); ?>
          <nav class="pied-page__legal" aria-label="<?php esc_attr_e( 'Informations légales', 'balneo-v2' ); ?>">
