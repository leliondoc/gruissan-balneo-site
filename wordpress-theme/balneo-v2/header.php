    ...
    <div class="utility-bar">
      <div class="utility-bar__inner">
        ...
        <nav aria-label="<?php esc_attr_e( 'Liens pratiques', 'balneo-v2' ); ?>">
          ...
          <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><i class="fa-solid fa-envelope context-icon" aria-hidden="true"></i><?php esc_html_e( 'Contact', 'balneo-v2' ); ?></a>
          <a href="https://www.gruissan-mediterranee.com" target="_blank" rel="noopener"><i class="fa-solid fa-arrow-up-right-from-square context-icon" aria-hidden="true"></i><?php esc_html_e( 'Gruissan Tourisme', 'balneo-v2' ); ?></a>
        </nav>
      </div>
    </div>
    <div class="site-header__inner">
      <?php balneo_v2_site_logo( 'header' ); ?>
      <button class="nav-toggle" type="button" aria-label="<?php esc_attr_e( 'Ouvrir le menu', 'balneo-v2' ); ?>" aria-expanded="false">
