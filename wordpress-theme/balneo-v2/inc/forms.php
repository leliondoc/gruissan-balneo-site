...
function balneo_v2_newsletter_signup(): void {
	...
	$message = implode(
		...
		array(
			...
			'',
			sprintf( /* translators: %s : prénom. */ __( 'Prénom : %s', 'balneo-v2' ), $first_name ),
			sprintf( /* translators: %s : nom. */ __( 'Nom : %s', 'balneo-v2' ), $last_name ),
			sprintf( /* translators: %s : adresse e-mail. */ __( 'E-mail : %s', 'balneo-v2' ), $email ),
			sprintf( /* translators: %s : code postal. */ __( 'Code postal : %s', 'balneo-v2' ), $postcode ),
			sprintf( /* translators: %s : ville. */ __( 'Ville : %s', 'balneo-v2' ), $city ),
