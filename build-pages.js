...
function logoNav(p) {
  return `<img class="image-logo" src="${p}/assets/logo-balneo-officiel.png" alt="Espace Balnéo Gruissan">`;
}
...
<head>
  ...
  <link rel="stylesheet" href="${p}/css/styles.css?v=20260820-3">
</head>
<body class="${isHome ? 'est-accueil' : ''}">
    ...
    <div class="barre-utilitaire">
      <div class="barre-utilitaire__interieur">
        ...
        <nav aria-label="Liens pratiques">
          ...
          <a href="${p}/pages/contact.html"><i class="fa-solid fa-envelope icone-contexte" aria-hidden="true"></i>Contact</a>
          <a href="https://www.gruissan-mediterranee.com" target="_blank" rel="noopener"><i class="fa-solid fa-arrow-up-right-from-square icone-contexte" aria-hidden="true"></i>Gruissan Tourisme</a>
        </nav>
      </div>
    </div>
    <div class="entete-site__interieur">
      <a href="${p}/index.html" class="logo-site" aria-label="Accueil — Espace Balnéo Gruissan">
        ${logoNav(p)}
      </a>
      <button class="bouton-navigation" type="button" aria-label="Ouvrir le menu" aria-expanded="false">
        <span></span><span></span><span></span>
      </button>
      <ul class="navigation-principale">
        <li class="avec-sous-menu">
          <button class="lien-navigation" type="button" aria-expanded="false">Se dépasser</button>
          <div class="sous-menu">
        ...
        <li class="avec-sous-menu">
          <button class="lien-navigation" type="button" aria-expanded="false">Lâcher-prise</button>
          <div class="sous-menu sous-menu--mega">
            <a class="menu-mega__carte menu-mega__carte--massages" href="${p}/pages/massages.html">
              <img src="${p}/assets/photos/dsc-0930.jpg" alt="">
              <span class="menu-mega__voile" aria-hidden="true"></span>
              <span class="menu-mega__contenu">
                <small>Soin du corps</small>
                <strong>Massages</strong>
                <span class="menu-mega__meta"><i class="fa-regular fa-calendar-check" aria-hidden="true"></i>Sur rendez-vous</span>
              </span>
            </a>
            <a class="menu-mega__carte menu-mega__carte--hydromassages" href="${p}/pages/hydromassages.html">
            ...
            <a class="menu-mega__carte menu-mega__carte--balneo" href="${p}/pages/balneo.html">
              <img src="${p}/assets/photos/balneo-188.jpg" alt="">
              <span class="menu-mega__voile" aria-hidden="true"></span>
              <span class="menu-mega__contenu">
                <small>Bains &amp; chaleur</small>
                <strong>Espace Balnéo</strong>
                <span class="menu-mega__meta"><i class="fa-regular fa-clock" aria-hidden="true"></i>Accès libre</span>
              </span>
            </a>
          </div>
        </li>
        <li class="avec-sous-menu">
          <button class="lien-navigation" type="button" aria-expanded="false">Pratiquer</button>
          <div class="sous-menu">
        ...
        <li class="avec-sous-menu">
          <button class="lien-navigation" type="button" aria-expanded="false">S'amuser</button>
          <div class="sous-menu">
            <a href="${p}/pages/parc-ete.html">Parc été</a>
          </div>
        </li>
        <li class="avec-sous-menu">
          <button class="lien-navigation" type="button" aria-expanded="false">Préparer</button>
          <div class="sous-menu sous-menu--droite sous-menu--pratique">
        ...
        <li class="navigation-principale__achat"><a href="https://gruissan-balneo.horanet.com/" target="_blank" rel="noopener">Acheter</a></li>
      </ul>
    </div>
  </header>`;
}
...
function footer(root) {
  const p = root ? '..' : '.';
  return `
  <a class="orbe-appel" href="https://gruissan-balneo.horanet.com/" target="_blank" rel="noopener"><span class="orbe-appel__libelle"><span>Acheter</span><small>en ligne</small></span></a>
  <footer class="pied-page-site">
    <div class="conteneur">
      <div class="pied-page__grille">
        <div class="pied-page__logo">
          <a href="${p}/index.html" class="pied-page__marque">${logoNav(p)}</a>
          <nav class="pied-page__legal" aria-label="Informations légales">
  ...
  <script>window.BALNEO_ANALYTICS={ga4Id:'G-4F2ZKB7RRZ',googleAdsId:'AW-358922226',storageKey:'balneo_cookie_consent',privacyUrl:'${p}/pages/donnees-personnelles.html'};</script>
  <script src="${p}/js/analytics.js?v=20260827-1"></script>
...
function infoBanner(text) {
  return `<div class="bandeau-info">
    <div class="conteneur"><span class="bandeau-info__message">${text}</span>
...
function pageHero(label, title, img) {
  ...
  return `<section class="hero-page">
    ...
    <div class="hero-page__contenu">
      <p class="hero-page__libelle">${label}</p>
      <h1 class="hero-page__titre">${title}</h1>
...
function contactSection(root) {
  const p = root ? '..' : '.';
  return `<section class="section-contenu section-contact" id="contact">
    <div class="conteneur">
      <div class="grille-contact apparition">
        ...
        <div>
          ...
          <form data-form>
            <div class="groupe-formulaire"><label for="prenom">Prénom</label><input type="text" id="prenom" name="prenom" required></div>
            <div class="groupe-formulaire"><label for="nom">Nom</label><input type="text" id="nom" name="nom" required></div>
          <div class="groupe-formulaire"><label for="email">E-mail</label><input type="email" id="email" name="email" required></div>
          <div class="groupe-formulaire"><label for="cp">Code postal</label><input type="text" id="cp" name="cp"></div>
          <div class="groupe-formulaire"><label for="ville">Ville</label><input type="text" id="ville" name="ville"></div>
          <div class="groupe-formulaire groupe-formulaire--consentement"><label for="consentement"><input type="checkbox" id="consentement" name="consentement" value="1" required>J’accepte de recevoir les actualités et j’ai lu la <a href="${p}/pages/donnees-personnelles.html">politique de confidentialité</a>.</label></div>
          <button type="submit" class="bouton">S'inscrire<i class="fa-solid fa-paper-plane" aria-hidden="true"></i></button>
          </form>
        </div>
      </div>
    </div>
...
<main>
  <section class="hero-accueil">
    ...
    <div class="hero-accueil__contenu apparition">
      ...
      <div class="groupe-boutons">
        ...
        <a href="pages/horaires.html" class="lien-texte lien-texte--clair">Voir les horaires <span>→</span></a>
      </div>
    </div>
  ...
  <section class="bienvenue section-contenu" id="bienvenue">
    <div class="conteneur bienvenue__grille apparition">
      ...
      <div class="bienvenue__texte">
        ...
        <a href="pages/balneo.html" class="lien-texte">Découvrir la Balnéo <span>→</span></a>
      </div>
    </div>
  </section>
  ...
  <section class="section-experiences" id="experiences">
    ...
    <div class="grille-experiences">
      <a href="pages/balneo.html" class="carte-experience carte-experience--grande apparition">
      ...
      <a href="pages/massages.html" class="carte-experience apparition">
      ...
      <a href="pages/salle-de-sport.html" class="carte-experience apparition">
      ...
      <a href="pages/parc-ete.html" class="carte-experience carte-experience--large apparition">
      ...
      <div class="carrousel-saisons__piste">
        <article class="diapositive-saison diapositive-saison--printemps" data-season="spring">
          ...
          <div class="diapositive-saison__contenu">
            ...
            <a href="pages/aquagym.html" class="bouton bouton--sur-photo">Bouger dans l'eau<i class="fa-solid fa-person-swimming" aria-hidden="true"></i></a>
          </div>
        </article>
        <article class="diapositive-saison diapositive-saison--ete" data-season="summer">
          ...
          <div class="diapositive-saison__contenu">
            ...
            <a href="pages/parc-ete.html" class="bouton bouton--sur-photo">Profiter du parc aquatique<i class="fa-solid fa-sun" aria-hidden="true"></i></a>
          </div>
        </article>
        <article class="diapositive-saison diapositive-saison--automne" data-season="fall">
          ...
          <div class="diapositive-saison__contenu">
            ...
            <a href="pages/massages.html" class="bouton bouton--sur-photo">Découvrir les massages<i class="fa-solid fa-spa" aria-hidden="true"></i></a>
          </div>
        </article>
        <article class="diapositive-saison diapositive-saison--hiver" data-season="winter">
          ...
          <div class="diapositive-saison__contenu">
            ...
            <a href="pages/balneo.html" class="bouton bouton--sur-photo">Explorer l'espace Balnéo<i class="fa-solid fa-hot-tub-person" aria-hidden="true"></i></a>
          </div>
        </article>
      </div>
    </div>
  ...
  <section class="manifeste section-contenu" id="experience-balneo">
    <div class="manifeste__photo media-plein"><img src="assets/photos/bassins-exterieurs.jpg" alt="Bassins extérieurs et jets massants de l'Espace Balnéo"></div>
    <div class="manifeste__contenu apparition">
      ...
      <a href="pages/balneo.html" class="bouton">Entrer dans l'univers<i class="fa-solid fa-hot-tub-person" aria-hidden="true"></i></a>
    </div>
  </section>
  ...
  <section class="section-contenu section-actualites">
    <div class="conteneur">
      <div class="entete-section apparition">
        ...
        <a href="pages/actualites.html" class="lien-texte">Toutes les actualités <span>→</span></a>
      </div>
      <div class="grille-actualites">
        <article class="carte-actualite apparition">
          ...
          <div class="carte-actualite__corps">
            ...
            <a href="pages/article-parc-ete.html" class="carte-actualite__lien">Lire plus</a>
          </div>
        </article>
        <article class="carte-actualite apparition">
          <div class="carte-actualite__media media-plein">
          ...
          <div class="carte-actualite__corps">
            ...
            <a href="pages/article-stages-natation.html" class="carte-actualite__lien">Lire plus</a>
          </div>
        </article>
        <article class="carte-actualite apparition">
          <div class="carte-actualite__media media-plein">
          ...
          <div class="carte-actualite__corps">
            ...
            <a href="pages/article-riviere.html" class="carte-actualite__lien">Lire plus</a>
          </div>
        </article>
      </div>
    </div>
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="deux-colonnes" style="margin-top:var(--space-md)">
      <div>
      ...
      <div class="deux-colonnes__media media-plein">
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="liste-services">
      <div class="element-service"><div><p class="element-service__nom">Détente anti-stress</p><p class="element-service__duree">30, 60 ou 90 min</p></div></div>
      ...
      <div class="element-service"><div><p class="element-service__nom">Tonique et décontractant</p><p class="element-service__duree">30 ou 60 min</p></div></div>
      <p class="element-service__description">Dynamisant et revitalisant, idéal pour les sportifs et la récupération musculaire.</p>
      <div class="element-service"><div><p class="element-service__nom">Tête — Mains — Pieds</p><p class="element-service__duree">30 ou 60 min</p></div></div>
      <div class="element-service"><div><p class="element-service__nom">Harmonisation des énergies</p><p class="element-service__duree">60 ou 90 min</p></div></div>
      <div class="element-service"><div><p class="element-service__nom">Massage femme enceinte</p><p class="element-service__duree">30 ou 60 min — 4e au 8e mois</p></div></div>
      <div class="element-service"><div><p class="element-service__nom">Massage douceur enfant</p><p class="element-service__duree">5 à 14 ans — accompagné en cabine</p></div></div>
      <div class="element-service"><div><p class="element-service__nom">Rituel Océan Relax</p><p class="element-service__duree">60 ou 90 min — à partir de 15 ans</p></div></div>
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Shorts et jupes de bain interdits</li><li>Pas de cours les jours fériés (sauf en été)</li><li>Pendant vacances zone C : aquagym les mardis à 9h45</li></ul></div>
    <h2>Les activités</h2>
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    <p><strong>Réservation au <a href="tel:+33468756050">04 68 75 60 50</a></strong></p>
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Shorts et jupes de bain interdits</li><li>Bonnet de bain conseillé</li><li>Pas de cours pendant vacances scolaires et jours fériés</li></ul></div>
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Shorts et jupes de bain interdits</li></ul></div>
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="grille-liens">
      <a class="carte-lien" href="balneo.html"><i class="fa-solid fa-water" aria-hidden="true"></i><h2>Eau &amp; chaleur</h2><p>Bassins à 32°C, jets massants, saunas, hammam et frigidarium.</p><span>Découvrir l'Espace Balnéo →</span></a>
      <a class="carte-lien" href="hydromassages.html"><i class="fa-solid fa-droplet" aria-hidden="true"></i><h2>Hydromassages</h2><p>Une séance habillée sur table à jets d'eau chaude, sur rendez-vous.</p><span>Voir les hydromassages →</span></a>
      <a class="carte-lien" href="massages.html"><i class="fa-solid fa-hands" aria-hidden="true"></i><h2>Massage décontractant</h2><p>Une approche tonique et personnalisée pour délier les zones sollicitées.</p><span>Voir les massages →</span></a>
    </div>
    ...
    <p><a class="bouton" href="contact.html">Nous demander conseil<i class="fa-solid fa-envelope" aria-hidden="true"></i></a></p>
  </div>
</section>
</main>`);
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Réservation obligatoire au <a href="tel:+33468756050">04 68 75 60 50</a></li><li>Shorts et jupes de bain interdits</li><li>Pas de cours les jours fériés, sauf programme estival</li><li>Pendant les vacances de la zone C : aquagym le mardi à 9h45</li></ul></div>
    <h2>Tarifs</h2>
    <div class="tableau-adaptatif"><table><tr><th>Formule</th><th>Tarif</th></tr><tr><td>1 séance</td><td>9 €</td></tr><tr><td>5 séances — validité 1 mois</td><td>41 €</td></tr><tr><td>10 séances — validité 1 an</td><td>81 €</td></tr><tr><td>Trimestre — hors été</td><td>105 €</td></tr></table></div>
    <p><a href="aquabike.html">Découvrir aussi l'Aquabike →</a></p>
  </div>
</section>
<div class="bande-appel"><p>Réservez votre séance d'Aquagym par téléphone.</p><a class="bouton" href="tel:+33468756050">Appeler le 04 68 75 60 50<i class="fa-solid fa-phone" aria-hidden="true"></i></a></div>
</main>`);
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Séance de 45 minutes</li><li>Réservation obligatoire au <a href="tel:+33468756050">04 68 75 60 50</a></li><li>Shorts et jupes de bain interdits</li><li>Pas de cours les jours fériés, sauf programme estival</li></ul></div>
    <h2>Tarifs</h2>
    <div class="tableau-adaptatif"><table><tr><th>Formule</th><th>Tarif</th></tr><tr><td>1 séance</td><td>11 €</td></tr><tr><td>12 séances — validité 1 an</td><td>121 €</td></tr><tr><td>24 séances — validité 1 an</td><td>231 €</td></tr></table></div>
    <p><a href="aquagym.html">Découvrir aussi l'Aquagym →</a></p>
  </div>
</section>
<div class="bande-appel"><p>Réservez votre séance d'Aquabike par téléphone.</p><a class="bouton" href="tel:+33468756050">Appeler le 04 68 75 60 50<i class="fa-solid fa-phone" aria-hidden="true"></i></a></div>
</main>`);
...
<section class="section-contenu section-contenu--claire">
  <div class="conteneur bloc-contenu apparition">
    ...
    <div class="encadre-info"><p class="encadre-info__titre">Côté pratique</p><ul><li>Réservation au <a href="tel:+33468756050">04 68 75 60 50</a></li><li>Shorts et jupes de bain interdits</li><li>Bonnet de bain conseillé</li><li>Pas de cours pendant les vacances scolaires et les jours fériés, hors stages annoncés</li></ul></div>
    ...
    <div class="tableau-adaptatif"><table><tr><th>Formule</th><th>Adultes</th><th>Enfants / ados</th></tr><tr><td>Carte 10 séances — 1 an</td><td>126 €</td><td>—</td></tr><tr><td>Carte 20 séances — 1 an</td><td>238 €</td><td>—</td></tr><tr><td>Abonnement annuel septembre–juin</td><td>295 €</td><td>185 €</td></tr></table></div>
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <div class="grille-liens">
    <a class="carte-lien" href="horaires.html"><i class="fa-solid fa-clock" aria-hidden="true"></i><h2>Horaires</h2><p>Consultez les horaires des différents espaces.</p><span>Voir les horaires →</span></a>
    <a class="carte-lien" href="tarifs.html"><i class="fa-solid fa-tag" aria-hidden="true"></i><h2>Tarifs</h2><p>Entrées, cartes, activités et abonnements.</p><span>Voir les tarifs →</span></a>
    <a class="carte-lien" href="acces-parking.html"><i class="fa-solid fa-route" aria-hidden="true"></i><h2>Accès &amp; parking</h2><p>Adresse, itinéraire et stationnement.</p><span>Préparer le trajet →</span></a>
    <a class="carte-lien" href="brochures.html"><i class="fa-solid fa-file-lines" aria-hidden="true"></i><h2>Brochures</h2><p>Les informations essentielles par univers.</p><span>Consulter les brochures →</span></a>
    <a class="carte-lien" href="faq.html"><i class="fa-solid fa-circle-question" aria-hidden="true"></i><h2>FAQ</h2><p>Les réponses aux questions les plus fréquentes.</p><span>Consulter la FAQ →</span></a>
    <a class="carte-lien" href="contact.html"><i class="fa-solid fa-envelope" aria-hidden="true"></i><h2>Contact</h2><p>Une question particulière ? Écrivez-nous ou appelez-nous.</p><span>Nous contacter →</span></a>
  </div>
  <div class="encadre-info"><p class="encadre-info__titre">Avant d'entrer dans l'eau</p><ul><li>Shorts et jupes de bain interdits</li><li>Cheveux longs attachés</li><li>Serviettes non fournies</li><li>Évacuation des bassins 15 minutes avant la fermeture</li></ul></div>
</div></section>
</main>`);
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <h2>Espace Balnéo</h2><div class="tableau-adaptatif"><table><tr><th>Formule</th><th>Tarif</th></tr><tr><td>Entrée 2h30 — 6 ans et plus</td><td>23 €</td></tr><tr><td>Entrée 2h30 — 3 à moins de 6 ans</td><td>11 €</td></tr><tr><td>Pass sans limite de temps — 6 ans et plus</td><td>29 €</td></tr><tr><td>Dernière heure</td><td>11 €</td></tr></table></div><p><a href="balneo.html">Voir tous les tarifs Balnéo et abonnements →</a></p>
  <h2>Activités</h2><div class="tableau-adaptatif"><table><tr><th>Activité</th><th>À partir de</th></tr><tr><td>Aquagym</td><td>9 € la séance</td></tr><tr><td>Aquabike</td><td>11 € la séance</td></tr><tr><td>Bébés nageurs</td><td>9 € par parent accompagnateur</td></tr><tr><td>Natation adultes</td><td>126 € les 10 séances</td></tr></table></div>
  <h2>Autres univers</h2><div class="grille-liens"><a class="carte-lien" href="salle-de-sport.html"><i class="fa-solid fa-dumbbell" aria-hidden="true"></i><h2>Espace For.Me</h2><p>Séances et abonnements.</p><span>Voir les tarifs →</span></a><a class="carte-lien" href="massages.html"><i class="fa-solid fa-spa" aria-hidden="true"></i><h2>Massages</h2><p>Prestations avec ou sans Balnéo.</p><span>Voir la carte →</span></a><a class="carte-lien" href="parc-ete.html"><i class="fa-solid fa-water-ladder" aria-hidden="true"></i><h2>Parc été</h2><p>Pass journée et tarifs enfants.</p><span>Voir les tarifs →</span></a></div>
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <div class="grille-liens">
    <a class="carte-lien" href="balneo.html"><i class="fa-solid fa-water" aria-hidden="true"></i><h2>Guide Balnéo</h2><p>Bassins, chaleur, détente et conditions d'accès.</p><span>Consulter le guide →</span></a>
    <a class="carte-lien" href="aquagym.html"><i class="fa-solid fa-person-swimming" aria-hidden="true"></i><h2>Guide des activités</h2><p>Aquagym, Aquabike, Bébés nageurs et Natation.</p><span>Découvrir les activités →</span></a>
    <a class="carte-lien" href="parc-ete.html"><i class="fa-solid fa-sun" aria-hidden="true"></i><h2>Guide Parc été</h2><p>Espaces, services, règles et tarifs de la saison estivale.</p><span>Préparer sa journée →</span></a>
  </div>
  ...
  <p><a class="bouton" href="contact.html">Demander une brochure<i class="fa-solid fa-file-lines" aria-hidden="true"></i></a></p>
</div></section>
</main>`);
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <div class="grille-tarifs"><div class="carte-tarif"><p class="carte-tarif__nom">Espace For.Me</p><p class="carte-tarif__prix"><i class="fa-solid fa-clock icone-contexte" aria-hidden="true"></i>6h–23h</p><p class="carte-tarif__description">7j/7 — dernier accès à 22h.</p></div><div class="carte-tarif"><p class="carte-tarif__nom">Espace Balnéo — été</p><p class="carte-tarif__prix"><i class="fa-solid fa-clock icone-contexte" aria-hidden="true"></i>10h–19h</p><p class="carte-tarif__description">Évacuation des bassins 15 minutes avant la fermeture.</p></div><div class="carte-tarif"><p class="carte-tarif__nom">Parc été</p><p class="carte-tarif__prix"><i class="fa-solid fa-clock icone-contexte" aria-hidden="true"></i>11h–18h</p><p class="carte-tarif__description">Ouverture saisonnière en juillet et août.</p></div></div>
  <div class="encadre-info"><p class="encadre-info__titre">Horaires du jour</p><p>Pour les horaires hors saison, les jours fériés, les activités encadrées ou une fermeture technique, vérifiez auprès de l'accueil au <a href="tel:+33468756050">04 68 75 60 50</a>.</p></div>
  <p><a class="bouton" href="contact.html">Contacter l'accueil<i class="fa-solid fa-envelope" aria-hidden="true"></i></a></p>
</div></section>
</main>`);
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <p><a class="bouton bouton--plein" href="contact.html">Demander une privatisation<i class="fa-solid fa-users" aria-hidden="true"></i></a></p>
</div></section>
</main>`);
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <div class="encadre-info"><p class="encadre-info__titre">Adresse</p><p><strong>Espace Balnéo de Gruissan</strong><br>Avenue des Bains<br>11430 Gruissan</p></div>
  <h2>Venir sur place</h2><div class="grille-liens"><div class="carte-lien"><i class="fa-solid fa-car" aria-hidden="true"></i><h2>En voiture</h2><p>Suivez la direction de l'Espace Balnéo. Le stationnement se fait sur les zones prévues autour du site.</p></div><div class="carte-lien"><i class="fa-solid fa-person-walking" aria-hidden="true"></i><h2>À pied ou à vélo</h2><p>Rejoignez l'équipement par les cheminements locaux depuis les secteurs proches.</p></div></div>
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">
  ...
  <p><a class="bouton" href="contact.html">Une autre question ?<i class="fa-solid fa-circle-question" aria-hidden="true"></i></a></p>
</div></section>
</main>`);
    ...
    <div class="grille-actualites">
      <article class="carte-actualite apparition">
        ...
        <div class="carte-actualite__corps">
          ...
          <h3 class="carte-actualite__titre">Ouverture du parc été</h3>
          <p class="carte-actualite__extrait">À partir du samedi 27 juin et jusqu'au dimanche 30 août inclus, le parc aqualudique vous accueille tous les jours de 11h à 18h.</p>
          <a href="article-parc-ete.html" class="carte-actualite__lien">Lire plus</a>
        </div>
      </article>
      <article class="carte-actualite apparition">
        <div class="carte-actualite__media media-plein">
        ...
        <div class="carte-actualite__corps">
          ...
          <a href="article-stages-natation.html" class="carte-actualite__lien">Lire plus</a>
        </div>
      </article>
      <article class="carte-actualite apparition">
        <div class="carte-actualite__media media-plein">
        ...
        <div class="carte-actualite__corps">
          ...
          <a href="article-riviere.html" class="carte-actualite__lien">Lire plus</a>
        </div>
      </article>
      <article class="carte-actualite apparition">
        <div class="carte-actualite__media media-plein">
...
<section class="section-contenu section-contenu--claire"><div class="conteneur bloc-contenu apparition">${content}
<p style="margin-top:var(--space-lg)"><a href="actualites.html" class="bouton"><i class="fa-solid fa-arrow-left" aria-hidden="true"></i>Toutes les actualités</a></p>
</div></section></main>`);
}
...
// Anciennes routes dont le contenu utile a rejoint la nouvelle navigation.
const retiredPages = [
...
// Écriture de toutes les pages de la maquette.
