    ...
    <div class="container">
      <div class="contact-grid fade-in">
        ...
        <div>
          ...
          <div class="form-group form-group--consent"><label for="consentement"><input type="checkbox" id="consentement" name="consentement" value="1" required>J’accepte de recevoir les actualités et j’ai lu la <a href="${p}/pages/donnees-personnelles.html">politique de confidentialité</a>.</label></div>
